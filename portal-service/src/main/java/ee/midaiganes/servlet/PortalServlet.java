...
public class PortalServlet extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		super.init(config);
		PortalUtil.setPortalContextPath(config.getServletContext().getContextPath());
		try {
			autowire();
	...
	private void includeTheme(HttpServletRequest request, HttpServletResponse response, Theme theme, RequestDispatcher requestDispatcher)
