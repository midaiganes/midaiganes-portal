...
class PortletJspRequest extends HttpServletRequestWrapper {
	...
	public PortletJspRequest(HttpServletRequest request, String portletContent, PortletNamespace namespace) {
		super(request);
