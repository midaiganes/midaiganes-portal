...
public class PortletURLImpl extends BaseURLImpl implements PortletURL {
    ...
    public PortletURLImpl(PortletRequestImpl request, PortletNamespace namespace, PortletLifecycle lifecycle) {
        this(request.getHttpServletRequest(), request.getHttpServletResponse(), namespace.getWindowID(), request.getAllowedWindowStates(), request.getAllowedPortletModes(),
                lifecycle, namespace.getPortletName());
    }

    public PortletURLImpl(HttpServletRequest request, HttpServletResponse response, String windowID, List<WindowState> allowedWindowStates, List<PortletMode> allowedPortletModes,
