...
import ee.midaiganes.portlet.impl.PortletSessionImpl;
...
public class PortletSessionImplTest {
	...
	public void setAttribute() {
		ps.setAttribute("test", true);
		Assert.assertEquals(ps.getAttribute("test"), true);
		Assert.assertNull(ps.getAttribute("test", PortletSession.APPLICATION_SCOPE));
	}

	@Test
	public void setAttributeApplicationScope() {
		ps.setAttribute("test", true, PortletSession.APPLICATION_SCOPE);
		Assert.assertEquals(ps.getAttribute("test", PortletSession.APPLICATION_SCOPE), true);
